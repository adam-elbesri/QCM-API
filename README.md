...
* URL de votre dépôt <https://forge.univ-lyon1.fr/p1810928/projet-lifap5-el-besri-adam>
* EL BESRI Adam #1
* NOM Prénom numet #2
* Nom de votre application (Quiz LIFAP5)
...
------------------------
 ...
 - Appuyer sur la loupe pour lancer la recherche.
 - Appuyer sur la croix pour une nouvelle recherche.
 
______________________________________________________________________________
        

        Pour localiser les catégories : 

* Catégorie"Formulaire de recherche" présente dans modeles.js
* Catégorie "mise à jour dynamique" présente dans websocket.js
* Catégorie "gestion des réponses" présente dans vues.js
